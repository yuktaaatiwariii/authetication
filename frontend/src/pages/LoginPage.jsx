...
const handleLogin = async (e) => {
 ...
 await login(email, password);
  ...
  return (
    ...
    className='max-w-md w-full    bg-emerald-900 bg-opacity-30 backdrop-filter backdrop-blur-xl rounded-2xl shadow-xl overflow-hidden'  
 >
...
<div className="flex items-center mb-6">
   <Link to="/forgot-password" className='text-green-400 font-semibold hover:underline' >
    Forgot Password?
   </Link>
</div>
...
<div className="px-8 py-4  bg-gray-900 bg-opacity-50 flex justify-center">
    <p className="text-sm  text-gray-400">Don't have an account?
     <Link to={"/signup"} className='text-green-400 ml-1 font-semibold hover:underline' >
     Sign up 
   </Link>
    </p>
     </div>
